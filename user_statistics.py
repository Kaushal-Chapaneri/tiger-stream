...
def user_stats(user_id):
    ...
    output :: html page containing user information, donut plot of user rated movie genres and bar plot of genres rated above 4
    """
    ...
    update_values = [str(user_id), str(query_response[2]['@@movieCountOfP']), str(round(query_response[1]['@@ratingAvg'], 1)), 
                    str(max(df['@timestampOfP'])), str(len(genre_values))+ " / 19"]
